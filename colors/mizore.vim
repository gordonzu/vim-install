...
hi Normal       guifg=#00ffff  ctermfg=darkcyan   guibg=#151515 ctermbg=black
...
hi Directory    guifg=#00bbdd  ctermfg=cyan       guibg=#151515 ctermbg=black
hi NonText      guifg=#77ff22  ctermfg=yellow     guibg=#151515 ctermbg=black  gui=bold cterm=bold
hi SpecialKey   guifg=#559933  ctermfg=green      guibg=#151515 ctermbg=black
...
hi Title        guifg=#dd4452 ctermfg=red       guibg=#151515 ctermbg=black  gui=bold cterm=bold
hi Question     guifg=#66d077 ctermfg=green     guibg=#151515 ctermbg=black
hi MoreMsg      guifg=#39d049 ctermfg=green     guibg=#151515 ctermbg=black
hi ErrorMsg     guifg=#ffffff ctermfg=white     guibg=#ff0000 ctermbg=red    gui=bold cterm=bold
hi WarningMsg   guifg=#ccae22 ctermfg=yellow    guibg=#151515 ctermbg=black  gui=bold cterm=bold


" syntax highlighting groups (:help group-name)

hi Comment      guifg=#b0b0b0  ctermfg=gray       guibg=#151515 ctermbg=black
hi Keyword      guifg=#2080ff  ctermfg=white       guibg=#151515 ctermbg=black
hi Statement    guifg=#2080ff  ctermfg=white       guibg=#151515 ctermbg=black  gui=bold cterm=bold 
hi StorageClass guifg=#b0ffb0  ctermfg=white       guibg=#151515 ctermbg=black  gui=bold cterm=NONE
hi Structure    guifg=#b0ffb0  ctermfg=white       guibg=#151515 ctermbg=black  gui=bold cterm=NONE
hi Type         guifg=#2080ff  ctermfg=white       guibg=#151515 ctermbg=black  gui=NONE
hi Identifier   guifg=#2080ff  ctermfg=white       guibg=#151515 ctermbg=black  gui=NONE cterm=NONE
hi Operator     guifg=#2080ff  ctermfg=white       guibg=#151515 ctermbg=black
hi Delimiter    guifg=#2080ff  ctermfg=white       guibg=#151515 ctermbg=black
hi Todo         guifg=#a00000  ctermfg=darkred     guibg=#151515 ctermbg=black  gui=bold cterm=bold
hi Error        guifg=#2080ff  ctermfg=white       guibg=#ff0000 ctermbg=red

hi Function     guifg=#bad9ff  ctermfg=blue        guibg=#151515 ctermbg=black  
...
hi Underlined   guifg=#80a0ff  ctermfg=cyan        guibg=#151515 ctermbg=black  gui=underline cterm=underline
hi Ignore       guifg=#888888  ctermfg=darkgray    guibg=#151515 ctermbg=black
hi Constant     guifg=#e080ff  ctermfg=magenta       guibg=#151515 ctermbg=black
hi Number       guifg=#e080ff  ctermfg=magenta       guibg=#151515 ctermbg=black
hi PreProc      guifg=#8070ff  ctermfg=darkmagenta   guibg=#151515 ctermbg=black
hi Macro        guifg=#8070ff  ctermfg=darkmagenta   guibg=#151515 ctermbg=black
hi Special      guifg=#ff40ff  ctermfg=magenta       guibg=#151515 ctermbg=black
